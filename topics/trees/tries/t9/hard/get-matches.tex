\question Given a trie containing the dictionary of words, define a procedure, \texttt{getWords}, that returns the set of matching words for a given key-press sequence.
