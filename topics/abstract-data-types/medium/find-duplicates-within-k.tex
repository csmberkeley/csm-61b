\question Define \texttt{findDuplicatesWithinK}, a procedure which, when given an \texttt{int[] array} and an boundary range $k$, returns a \texttt{Set} of all  duplicates within $k$ indices of each other.
