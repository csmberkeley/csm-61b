...
\begin{solution}[1.5in]
This would be in $\Theta(1)$ since at any given length, $N$, we can insert
$N/2$ elements before having to resize.

Longer explanation: Given a full array of size $\frac{N}{2}$, the runtime of
resizing it would be in $\Theta(N)$. This new array of size $N$ would allow us
to insert $\frac{N}{2}$ elements before having to resize again. This means the
runtime of inserting each one of those elements, amortized, is in
